...
setup(
    ...
    url="https://github.com/bodharma/webdriverdownloader",
    authors=["Leonides T. Saguisag Jr.", "Bohdan Lesiv"],
    author_email=["leonidessaguisagjr@gmail.com", "boghdanlesiv@gmail.com"],
    license="MIT",
